...
public class ListTest {
    ...
    // 解析：ArrayList每次新增都是在数组后面新增元素，虽然每次扩容会重新复制一个数组，但是由于物理内存地址是连续的，所以IO的寻址上面是优于LinkedList的
...
// 迭代器就是一种视图，他屏蔽了多种数据结构的不同，以一种相同的方式来对数据继续遍历，更新操作
    // foreach底层使用的是iterator进行遍历
